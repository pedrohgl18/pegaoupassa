...
```
| 10/12/2025 | **UX - Flip Card** | Intera��o de tap-to-flip melhorada, layout do verso ajustado (Nome > Fotos), contador de likes oculto no verso. |
| 10/12/2025 | **UX - Flip Card Layout** | Ajuste de grid para Profiss�o/Escolaridade (largura total) para evitar overflow. |
