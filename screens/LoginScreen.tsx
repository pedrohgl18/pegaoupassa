...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin, onEmailLogin }) => {
                    ...
                    <>
                        ...
                        <div className="w-full max-w-sm space-y-4 animate-slide-up" style={{ animationDelay: '0.2s' }}>
                            ...
                            <button
                                ...
                                disabled={loginLoading}
                                className="w-full h-14 bg-zinc-900 hover:bg-zinc-800 text-white font-bold text-lg rounded-full shadow-lg border border-transparent flex items-center justify-center gap-3 transition-all active:scale-95"
                            >
                                <Mail size={24} />
                        ...
                        <form onSubmit={handleEmailAuth} className="space-y-4">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full h-14 pl-12 pr-4 bg-zinc-50 border border-zinc-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 transition-all"
                                    required
                                />
                            </div>
                            ...
                            <button
                                type="submit"
                                disabled={loginLoading}
                                className="w-full h-14 bg-violet-600 hover:bg-violet-700 text-white font-bold text-lg rounded-2xl shadow-lg shadow-violet-200 flex items-center justify-center transition-all active:scale-95 disabled:opacity-50"
                            >
